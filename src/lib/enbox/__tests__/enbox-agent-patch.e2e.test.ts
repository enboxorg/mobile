 ...
 *
 * This test imports the real `@enbox/agent` package and calls
 * `agent.initialize()` so the patch is verified against the production
 * surface, not only a local mirror of the short-circuit.
 */
