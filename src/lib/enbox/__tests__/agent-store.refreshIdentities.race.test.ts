 ...
 * via the getter.
 *
 * `refreshIdentities()` gates on a safe `agent.agentDid` probe and
 * returns silently when the DID has not yet been observed. Once the
 * DID is assigned, it resumes normal behavior.
 *
