...
// ===========================================================================
// destroyRNLevelDatabase fail-closed contract
// ===========================================================================
//
...
describe('destroyRNLevelDatabase — fail-closed contract', () => {
  ...
  it('rethrows "is not a function" to catch turbomodule mislinks', async () => {
...
// ===========================================================================
// destroyAgentLevelDatabases must wipe the root sync DB too
// ===========================================================================
//
...
// child-only wipe destroyed a non-existent subpath while every byte of
...
describe('destroyAgentLevelDatabases — sync-at-root wipe', () => {
