...
describe('SettingsScreen', () => {
  ...
  describe('VAL-UX-036 — reset wallet flow', () => {
    ...
    // This pins the fail-loud reset contract. A real Keystore
    ...
    it('surfaces the reset failure via Alert AND suppresses hydrate when agentStore.reset() rejects', async () => {
      ...
      try {
        ...
        //   capturedAlerts[1] = the reset failure alert.
